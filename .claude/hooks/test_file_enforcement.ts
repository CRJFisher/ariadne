...
// Directories whose contents are auto-generated by codegen and exercised
// through their parent orchestrator's tests (no per-file unit test required).
// Currently: classifier sources rendered from the known-issues registry.
const GENERATED_DIRECTORIES = new Set(["builtins"]);
