...
│   ├── namespace_member.ts       # The member a namespace hop names (namespace block body, namespace import exports)
...
- **`TypeRegistry`** — Resolved type relationships: value types, value type arguments, container elements, callable return types, type members; walks inheritance over the heritage graph
