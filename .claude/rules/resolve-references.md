...
│   ├── type_parameter_resolution.ts # The receiver-shaped evidence: a generic member's return at a chained call (`infer_generic_return`), and a binding whose annotation names a type parameter (`resolve_type_parameter_annotation`)
