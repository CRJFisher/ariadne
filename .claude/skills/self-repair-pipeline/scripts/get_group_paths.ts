 ...
 * Read/Write of triage state, per-entry results, and pass2 output.
 *
 * Usage:
 ...
 *     "pass2_dir": "<abs path to aggregation/pass2/>"
 *   }
 */
...
export function build_group_paths(run: ResolvedRun): GroupPaths {
  return {
    ...
    pass2_dir: path.join(run.run_dir, AGGREGATION_SUBDIR, "pass2"),
  };
}
