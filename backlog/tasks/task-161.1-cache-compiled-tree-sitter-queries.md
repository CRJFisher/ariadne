...
- [ ] `Query` objects cached per language in module-level Map
- [ ] `query_tree()` uses cached query when available
- [ ] `clear_query_cache()` function exported for testing
- [ ] Profiler instrumentation updated
