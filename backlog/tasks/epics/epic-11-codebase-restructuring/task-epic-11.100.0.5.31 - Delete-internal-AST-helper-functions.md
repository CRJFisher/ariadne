# Task 11.100.0.5.31: Delete Internal AST Helper Functions
...
export function find_function_calls(tree: Parser.Tree, source: string, language: Language): FunctionCall[] {
...
## Dependencies
- Task 27: Stub implementations in place
- Task 29: Language-specific files deleted

## Follow-up Tasks
- Task 32: Update tests for stub behavior
- Task 33: Document migration path to queries