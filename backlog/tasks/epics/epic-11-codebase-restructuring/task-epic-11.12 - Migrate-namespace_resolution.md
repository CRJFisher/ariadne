...
- [ ] Find all tests related to namespace resolution
...
- [ ] Create folder structure at src/import_export/namespace_resolution/
- [ ] Move/create common namespace_resolution.ts
...
- [ ] Move/create namespace_resolution.test.ts
