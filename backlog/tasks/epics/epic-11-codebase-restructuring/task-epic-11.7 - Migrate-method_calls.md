...
- [ ] Find method resolution logic location
- [ ] Document all language-specific implementations
- [ ] Identify common logic vs language-specific logic

### Test Location

- [ ] Find all tests related to method calls
- [ ] Find method resolution tests
...
- [ ] Create folder structure at src/call_graph/method_calls/
- [ ] Move/create common method_calls.ts
...
- [ ] Move/create method_calls.test.ts
