...
- [ ] Find where constructor call detection currently lives
- [ ] Document all language-specific implementations
- [ ] Identify common logic vs language-specific logic

### Test Location

- [ ] Find all tests related to constructor calls
...
- [ ] Create folder structure at src/call_graph/constructor_calls/
- [ ] Move/create common constructor_calls.ts
...
- [ ] Move/create constructor_calls.test.ts
