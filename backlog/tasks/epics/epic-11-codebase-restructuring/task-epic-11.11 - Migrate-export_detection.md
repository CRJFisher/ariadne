...
- [ ] Find all tests related to export detection
...
- [ ] Create folder structure at src/import_export/export_detection/
- [ ] Move/create common export_detection.ts
...
- [ ] Move/create export_detection.test.ts
