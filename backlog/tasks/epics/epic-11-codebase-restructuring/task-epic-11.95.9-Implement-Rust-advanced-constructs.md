...
- `should capture const generics and associated types` - const generics not detected
- `should capture unsafe blocks and functions` - unsafe constructs missing
- `should capture loop variables and iterators` - loop constructs not captured
- `should track method calls with receivers` - method call tracking incomplete
