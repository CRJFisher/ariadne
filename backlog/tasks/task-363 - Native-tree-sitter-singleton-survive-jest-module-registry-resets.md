...
- [ ] #1 A process-global loader module owns every runtime require of tree-sitter and the grammar packages; no other module requires them directly (grep-enforceable)
- [ ] #2 Compiled Query objects in query_loader are cached in the same process-global store
