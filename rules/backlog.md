...
<!-- USER ADDITIONS TO BACKLOG.MD GUIDELINES START -->
...
- **Always run from root**: Execute backlog commands from the project root directory
- **Rich context for sub-tasks**: When creating sub-tasks, include detailed context from the parent task - specific code locations, error messages, and implementation considerations beyond basic requirements

### During Implementation

- **Stay focused**: If you discover unrelated issues, create a new task rather than expanding scope
- **No shortcuts**: Complete work properly or create a follow-up task - never leave half-finished implementations

### Post-Implementation

- **Always add Implementation Notes**: Document your approach, decisions, and any discovered issues
- **Archive completed tasks**: Use `backlog task archive <id>` after marking as Done
- **Update project state**: Review `task-dependencies.yaml` and `WORK_PRIORITY.md` for necessary updates
- **Check next priority**: Consult WORK_PRIORITY.md to determine what to work on next

See `rules/backlog-post.md` for the complete post-work checklist.

<!-- USER ADDITIONS TO BACKLOG.MD GUIDELINES END -->