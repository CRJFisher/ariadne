...
/**
 * Script to extract TypeScript type definitions from the main refscope source
 * and generate the corresponding .d.ts files for the refscope-types package.
 */
 ...
 */
function syncTypes() {
  console.log('Extracting types from refscope source...');
