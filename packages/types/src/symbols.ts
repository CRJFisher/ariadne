...
import { SymbolId, SymbolName, FilePath, FunctionName, ScopeId, DocString } from './aliases';

export interface Definition {
  readonly symbol: SymbolName;
  readonly kind: 'function' | 'class' | 'variable' | 'constant' | 'type' | 'interface' | 'enum';
...
export interface SymbolIndex {
  readonly definitions: ReadonlyMap<SymbolId, Definition>;
