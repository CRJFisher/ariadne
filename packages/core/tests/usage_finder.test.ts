...
} from '../src/scope_analysis/usage_finder';
...
describe('Usage Finder', () => {
  describe('JavaScript', () => {
    ...
    it('should find variable usages', () => {
      ...
      const usages = find_usages(def, scope_tree, language, 'test.js', tree.rootNode, code);
    ...
    it('should find function calls', () => {
      ...
      const calls = find_function_calls(scope_tree, language, 'test.js', tree.rootNode, code);
    ...
    it('should find destructuring usages', () => {
      ...
      const obj_usages = find_usages(obj_def, scope_tree, language, 'test.js', tree.rootNode, code);
      const arr_usages = find_usages(arr_def, scope_tree, language, 'test.js', tree.rootNode, code);
  ...
  describe('Cross-language features', () => {
    ...
    it('should find variable writes', () => {
      ...
      const writes = find_variable_writes(scope_tree, language, 'test.js', tree.rootNode, code);
