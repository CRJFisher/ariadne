...
import {
  ...
  find_all_by_kind
} from '../src/scope_analysis/definition_finder';
...
describe('Definition Finder', () => {
  describe('JavaScript', () => {
    ...
    it('should find function definition', () => {
      ...
      const context = create_definition_context(scope_tree, 'test.js', code, language, tree.rootNode);
      
      // Find definition of myFunction
      const def = find_definition_with_language('myFunction', scope_tree.root_id, context, language);
    ...
    it('should find variable definition', () => {
      ...
      const def = find_definition_with_language('myVar', scope_tree.root_id, context, language);
      expect(def).toBeDefined();
    ...
    it('should find class definition', () => {
      ...
      const def = find_definition_with_language('MyClass', scope_tree.root_id, context, language);
      expect(def).toBeDefined();
  ...
  describe('TypeScript', () => {
    ...
    it('should find interface definition', () => {
      ...
      const tree = parser.parse(code);
      const scope_tree = build_scope_tree(tree.rootNode, code, language);
      const context = create_definition_context(scope_tree, 'test.ts', code, language, tree.rootNode);
      
      // Find definition of User
      const def = find_definition_with_language('User', scope_tree.root_id, context, language);
...
result = my_function()
      ...
      const tree = parser.parse(code);
      const scope_tree = build_scope_tree(tree.rootNode, code, language);
      const context = create_definition_context(scope_tree, 'test.py', code, language, tree.rootNode);
      
      // Find definition of my_function
      const def = find_definition_with_language('my_function', scope_tree.root_id, context, language);
      expect(def).toBeDefined();
...
fn main() {
    let result = my_function();
      ...
      const tree = parser.parse(code);
      const scope_tree = build_scope_tree(tree.rootNode, code, language);
      const context = create_definition_context(scope_tree, 'test.rs', code, language, tree.rootNode);
...
fn main() {
    let s = MyStruct::new(42);
      ...
      const def = find_definition_with_language('MyStruct', scope_tree.root_id, context, language);
      expect(def).toBeDefined();
  ...
  describe('Cross-language features', () => {
    ...
    it('should find exported definitions', () => {
      ...
      const exported = get_exported_definitions(scope_tree, 'test.js', language);
