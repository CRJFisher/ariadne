...
describe("Large file handling", () => {
  test("handles files larger than 32KB with bufferSize option", { timeout: 30000 }, () => {
...
`;
    ...
    console.log(`File size: ${(Buffer.byteLength(largeContent, 'utf8') / 1024).toFixed(1)}KB`);
...
function test() {
  ...
  return emoji + chinese;
    ...
    console.log(`String length: ${stringLength} chars, Byte length: ${byteLength} bytes`);
