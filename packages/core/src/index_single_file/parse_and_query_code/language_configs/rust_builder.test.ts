...
describe.skip("rust_builder", () => {
  ...
  function processCapture(
    ...
    if (!node) {
      throw new Error(`Node of type ${nodeType} with text "${expectedText}" not found`);
    }
  ...
  describe("struct definitions", () => {
    it("should process simple struct", () => {
      ...
      const definitions = processCapture(code, "def.struct", "type_identifier", "MyStruct");
    ...
    it("should process generic struct", () => {
      ...
      const definitions = processCapture(code, "def.struct.generic", "type_identifier", "Container");
    ...
    it("should process tuple struct", () => {
      ...
      const definitions = processCapture(code, "def.struct", "type_identifier", "Point");
    ...
    it("should handle pub(crate) visibility", () => {
      ...
      const definitions = processCapture(code, "def.struct", "type_identifier", "InternalStruct");
  ...
  describe("enum definitions", () => {
    it("should process simple enum", () => {
      ...
      const definitions = processCapture(code, "def.enum", "type_identifier", "Status");

      expect(definitions.enums).toHaveLength(1);
      expect(definitions.enums[0].name).toBe("Status");
      expect(definitions.enums[0].members).toEqual(["Success", "Error", "Pending"]);
    ...
    it("should process generic enum", () => {
      ...
      const definitions = processCapture(code, "def.enum.generic", "type_identifier", "Result");
    ...
    it("should process enum with complex variants", () => {
      ...
      const definitions = processCapture(code, "def.enum", "type_identifier", "Message");
  ...
  describe("trait definitions", () => {
    it("should process simple trait", () => {
      ...
      const definitions = processCapture(code, "def.trait", "type_identifier", "Display");
    ...
    it("should process generic trait", () => {
      ...
      const definitions = processCapture(code, "def.interface.generic", "type_identifier", "Iterator");
  ...
  describe("function definitions", () => {
    it("should process simple function", () => {
      ...
      const definitions = processCapture(code, "def.function", "identifier", "calculate");
    ...
    it("should process async function", () => {
      ...
      const definitions = processCapture(code, "def.function.async", "identifier", "fetch_data");
    ...
    it("should process const function", () => {
      ...
      const definitions = processCapture(code, "def.function.const", "identifier", "compute");
    ...
    it("should process unsafe function", () => {
      ...
      const definitions = processCapture(code, "def.function.unsafe", "identifier", "raw_access");
    ...
    it("should process generic function", () => {
      ...
      const definitions = processCapture(code, "def.function.generic", "identifier", "compare");
  ...
  describe("variable and constant definitions", () => {
    it("should process let binding", () => {
      ...
      const definitions = processCapture(code, "def.variable", "identifier", "count");
    ...
    it("should process const definition", () => {
      ...
      const definitions = processCapture(code, "def.const", "identifier", "MAX_SIZE");
    ...
    it("should process static variable", () => {
      ...
      const definitions = processCapture(code, "def.static", "identifier", "COUNTER");
  ...
  describe("parameter definitions", () => {
    it("should process function parameter", () => {
      ...
      const definitions = processCapture(code, "def.parameter", "identifier", "data");
    ...
    it("should process mutable parameter", () => {
      ...
      const definitions = processCapture(code, "def.param", "identifier", "value");
  ...
  describe("type definitions", () => {
    it("should process type alias", () => {
      ...
      const definitions = processCapture(code, "def.type_alias", "type_identifier", "Result");
    ...
    it("should process module definition", () => {
      ...
      const definitions = processCapture(code, "def.module", "identifier", "utils");
  ...
  describe("visibility extraction", () => {
    it("should detect pub visibility", () => {
      ...
      const definitions = processCapture(code, "def.function", "identifier", "public_func");
      expect(definitions.functions[0].availability.scope).toBe("public");
    });

    it("should detect pub(crate) visibility", () => {
      const code = `pub(crate) struct CrateStruct {}`;
      const definitions = processCapture(code, "def.struct", "type_identifier", "CrateStruct");
      expect(definitions.classes[0].availability.scope).toBe("package");
    });

    it("should detect pub(super) visibility", () => {
      const code = `pub(super) enum SuperEnum {}`;
      const definitions = processCapture(code, "def.enum", "type_identifier", "SuperEnum");
    ...
    it("should default to file-private for no visibility", () => {
      ...
      const definitions = processCapture(code, "def.struct", "type_identifier", "PrivateStruct");
      expect(definitions.classes[0].availability.scope).toBe("file-private");
    });
  });
  ...
  describe("macro definitions", () => {
    it("should process macro definition", () => {
      ...
      const definitions = processCapture(code, "def.macro", "identifier", "debug_log");
  ...
  describe("integration tests", () => {
    it("should handle complex struct with multiple features", () => {
      ...
      if (structNode) {
        const definitions = processCapture(code, "def.struct.generic", "type_identifier", "Database");
        expect(definitions.classes).toHaveLength(1);
    ...
    it("should handle trait with associated types and default methods", () => {
      ...
      const definitions = processCapture(code, "def.trait", "type_identifier", "Iterator");
      expect(definitions.interfaces).toHaveLength(1);
      expect(definitions.interfaces[0].name).toBe("Iterator");
    });
  });
