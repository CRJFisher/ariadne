...
export const RUST_METADATA_EXTRACTORS: MetadataExtractors = {
   ...
   *
   * Rust: Extract locations of arguments from arguments field
   *
  ...
  extract_argument_locations(
    ...
    // For function calls, the query might capture the identifier, not the call_expression
    ...
    if (!arguments_node || arguments_node.type !== "arguments") {
      return undefined;
    }
