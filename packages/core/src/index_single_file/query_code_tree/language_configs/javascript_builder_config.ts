...
import { JAVASCRIPT_REEXPORT_CONFIG } from "./javascript_reexport_config";


// ============================================================================
// JavaScript/TypeScript Base Builder Configuration
// ============================================================================
...
// ============================================================================
// COMBINED JAVASCRIPT CONFIG - Merges base config with re-export handlers
// ============================================================================

export const JAVASCRIPT_BUILDER_CONFIG: LanguageBuilderConfig = new Map([
  ...JAVASCRIPT_BASE_CONFIG,
  ...JAVASCRIPT_REEXPORT_CONFIG,
]);
