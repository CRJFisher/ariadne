...
describe("resolve_type_tracking", () => {
  ...
  beforeEach(() => {
    ...
    file_types.set("MyClass" as SymbolName, "class:MyClass:test.ts:1:0" as TypeId);
    file_types.set("UserInfo" as SymbolName, "interface:UserInfo:test.ts:5:0" as TypeId);
  ...
  describe("Type annotation resolution", () => {
    it("should resolve built-in types to TypeIds", () => {
      ...
      const y_symbol = variable_symbol("y" as SymbolName, { ...mock_location, line: 2, end_line: 2 });
    ...
    it("should resolve custom types from registry", () => {
      ...
      expect(resolved.variable_types.get(obj_symbol)).toBe("class:MyClass:test.ts:1:0");
    });
    ...
    it("should handle array syntax", () => {
      ...
      const items_symbol = variable_symbol("items" as SymbolName, mock_location);
    ...
    it("should handle union types", () => {
      ...
      const mixed_symbol = variable_symbol("mixed" as SymbolName, mock_location);
    ...
    it("should handle generic types", () => {
      ...
      const promise_symbol = variable_symbol("promise" as SymbolName, { ...mock_location, line: 2, end_line: 2 });

      // Generic parsing extracts base type
      expect(resolved.variable_types.get(map_symbol)).toBe("builtin:Map");
      expect(resolved.variable_types.get(promise_symbol)).toBe("builtin:Promise");
    });
    ...
    it("should populate expression_types for annotations", () => {
      ...
      expect(resolved.expression_types.get(mock_location)).toBe("builtin:string");
    });
  });
  ...
  describe("Type inference from initializers", () => {
    it("should infer types from literal values", () => {
      ...
      const num_symbol = variable_symbol("num" as SymbolName, { ...mock_location, line: 2, end_line: 2 });
      const bool_symbol = variable_symbol("bool" as SymbolName, { ...mock_location, line: 3, end_line: 3 });
    ...
    it("should infer types from constructor calls", () => {
      ...
      const instance_symbol = variable_symbol("instance" as SymbolName, mock_location);
      expect(resolved.variable_types.get(instance_symbol)).toBe("class:MyClass:test.ts:1:0");
    });
    ...
    it("should use type annotation over initializer when both exist", () => {
      ...
      expect(resolved.variable_types.get(x_symbol)).toBe("class:MyClass:test.ts:1:0");
    });
    ...
    it("should infer null and undefined types", () => {
      ...
      const null_symbol = variable_symbol("nullVar" as SymbolName, mock_location);
      const undef_symbol = variable_symbol("undefVar" as SymbolName, { ...mock_location, line: 2, end_line: 2 });

      expect(resolved.variable_types.get(null_symbol)).toBe("builtin:null");
      expect(resolved.variable_types.get(undef_symbol)).toBe("builtin:undefined");
    });
    ...
    it("should infer array and object literal types", () => {
      ...
      const obj_symbol = variable_symbol("obj" as SymbolName, { ...mock_location, line: 2, end_line: 2 });
  ...
  describe("Type flow through assignments", () => {
    ...
    it("should handle compound assignment operators", () => {
      ...
      const count_symbol = variable_symbol("count" as SymbolName, mock_location);
  ...
  describe("Cross-file tracking", () => {
    it("should resolve types across multiple files", () => {
      ...
      const x_symbol = variable_symbol("x" as SymbolName, mock_location);
      const y_symbol = variable_symbol("y" as SymbolName, { ...mock_location, file_path: file2 });

      expect(resolved.variable_types.get(x_symbol)).toBe("interface:UserInfo:test.ts:5:0");
      expect(resolved.variable_types.get(y_symbol)).toBe("class:MyClass:test.ts:1:0");
    });
  });
