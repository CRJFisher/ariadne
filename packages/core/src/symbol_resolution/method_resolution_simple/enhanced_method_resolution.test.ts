...
import { parse_code } from "../../parse_and_query_code/parse_and_query_code";
import { build_semantic_index } from "../../semantic_index/semantic_index";
...
describe("Enhanced Method Resolution", () => {
  describe("TypeScript", () => {
    ...
    it("should compare with original resolution", async () => {
      ...
      const { build_local_type_context } = await import("../local_type_context/local_type_context");
      ...
      console.log(`Original resolved: ${original_results.method_calls.size} methods`);
      console.log(`Enhanced resolved: ${enhanced_results.method_calls.size} methods`);
