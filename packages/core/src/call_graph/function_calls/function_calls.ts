 ...
 */
export function is_function_call_node(
  node: SyntaxNode,
  language: Language
): boolean {
...
export function extract_callee_name(
  ...
  const function_node =
    node.childForFieldName("function") || node.childForFieldName("func"); // Python uses 'func'
  ...
  if (
    ...
    function_node.type === "attribute"
  ) {
    // Python uses 'attribute'
    const property =
      function_node.childForFieldName("property") ||
 ...
 */
export function is_method_call(node: SyntaxNode, language: Language): boolean {
  const function_node =
    node.childForFieldName("function") || node.childForFieldName("func");
 ...
 */
export function count_arguments(node: SyntaxNode, language: Language): number {
...
function extract_function_name(
  ...
  const name_node =
    node.childForFieldName("name") || node.childForFieldName("key"); // method_definition uses 'key'
