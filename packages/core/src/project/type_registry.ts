...
export class TypeRegistry {
   ...
   */
  update_file(file_path: FilePath, derived: DerivedData): void {
    ...
    for (const [location_key, type_name] of derived.type_bindings) {
    ...
    for (const [alias_id, type_expression] of derived.type_alias_metadata) {
