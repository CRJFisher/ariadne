// AUTO-GENERATED barrel — do not edit by hand. Regenerated by the deferred
// actuator whenever the known-issues registry mutates. The orchestrator looks
// up a builtin classifier by `function_name` via BUILTIN_CHECKS.
