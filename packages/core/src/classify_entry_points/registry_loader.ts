 ...
 * curator's working copy. Core ships only the permanent slice; the slice JSON
 * is regenerated by `pnpm sync-permanent-rules` and copied into `dist/` by
 * the `copy-permanent-registry` script in `package.json`.
 *
