...
import { build_javascript_scope_tree, resolve_javascript_symbol } from './scope_tree.javascript';
import { build_typescript_scope_tree } from './scope_tree.typescript';
import { build_python_scope_tree, resolve_python_symbol } from './scope_tree.python';
...
export { build_javascript_scope_tree, resolve_javascript_symbol } from './scope_tree.javascript';
export { build_typescript_scope_tree } from './scope_tree.typescript';
export { build_python_scope_tree, resolve_python_symbol } from './scope_tree.python';
export { build_rust_scope_tree, resolve_rust_symbol } from './scope_tree.rust';
