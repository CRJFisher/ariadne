/**
 * New class hierarchy implementation using enhanced shared types directly.
 * This will replace the old class_hierarchy.ts once migration is complete.
 */
 ...
 */
export function build_class_hierarchy_new(
