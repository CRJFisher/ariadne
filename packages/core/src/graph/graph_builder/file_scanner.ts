...
/**
 * Read a file and create a StoredFile-like structure
 */
export async function read_file(file_path: string): Promise<StoredFile> {
  ...
  return {
    ...
    source_code,
    language,
    tree: undefined, // Will be parsed during analysis
