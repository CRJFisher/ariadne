...
describe("Import Resolution", () => {
  describe("Core Resolution Algorithm", () => {
    ...
    beforeEach(() => {
      ...
      const components_index = create_test_index(
        ...
        [
          {
            ...
            location: {
              file_path: "/src/components.ts" as FilePath,
              start_line: 5,
              start_column: 0,
              end_line: 5,
              end_column: 0,
        ...
        new Map([["components:Button" as SymbolId, {} as SymbolDefinition]]),
        "typescript" as Language
      );
    ...
    it("should resolve named imports", () => {
      ...
      expect(main_imports?.get("processData" as SymbolName)).toBe(
        "processData_symbol"
      );
      expect(main_imports?.get("formatDate" as SymbolName)).toBe(
        "processData_symbol"
      );
    });
    ...
    it("should resolve default imports", () => {
      ...
      const main_imports = result.get("/src/main.ts" as FilePath);
      expect(main_imports).toBeDefined();
      expect(main_imports?.get("Button" as SymbolName)).toBe(
        "components:Button"
      );
    });
    ...
    it("should skip side-effect imports", () => {
      const indices = new Map<FilePath, SemanticIndex>();
      const index = create_test_index("/src/app.ts" as FilePath, [
        {
          kind: "side_effect" as const,
          source: "./polyfills" as FilePath,
          location: {
            file_path: "/src/app.ts" as FilePath,
            start_line: 1,
            start_column: 0,
            end_line: 1,
            end_column: 0,
  ...
  describe("Namespace Import Resolution", () => {
    it("should resolve namespace imports", () => {
      ...
      const main_index = create_test_index("/src/main.ts" as FilePath, [
        {
        ...
        [
          {
            ...
            location: {
              file_path: "/src/a.ts" as FilePath,
              start_line: 1,
              start_column: 0,
              end_line: 1,
              end_column: 0,
        ...
        [
          {
            ...
            exports: [
              { local_name: "fromA" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/a.ts" as FilePath,
              start_line: 2,
        ...
        [
          {
            ...
            location: {
              file_path: "/src/b.ts" as FilePath,
              start_line: 1,
              start_column: 0,
              end_line: 1,
              end_column: 0,
        ...
        [
          {
            ...
            exports: [
              { local_name: "fromB" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/b.ts" as FilePath,
              start_line: 2,
  ...
  describe("Complex Import Scenarios", () => {
        ...
        [
          {
            ...
            exports: [
              { local_name: "func1" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/utils.ts" as FilePath,
              start_line: 1,
          ...
          },
          {
            ...
            exports: [
              { local_name: "func2" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/utils.ts" as FilePath,
              start_line: 2,
          ...
          },
          {
            ...
            exports: [
              { local_name: "func3" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/utils.ts" as FilePath,
              start_line: 3,
    ...
    it("should handle aliased imports", () => {
        ...
        [
          {
            ...
            exports: [
              { local_name: "originalName" as SymbolName, is_type_only: false },
            ],
            location: {
              file_path: "/src/utils.ts" as FilePath,
              start_line: 1,
      ...
      expect(main_imports?.get("aliasedName" as SymbolName)).toBe(
        "utils:originalName"
      );
