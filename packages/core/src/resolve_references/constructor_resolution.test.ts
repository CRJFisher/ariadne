...
import { class_symbol, location_key } from "@ariadnejs/types";
...
describe("Constructor Resolution", () => {
  describe("Cross-file constructor resolution", () => {
    it("should resolve constructor calls to imported classes", () => {
      ...
      const resolved_constructor =
        result.phases.methods.constructor_calls.get(constructor_call_key);
      ...
      expect(result.resolved_references.get(constructor_call_key)).toBe(
        my_class_symbol
      );
    });
    ...
    it("should handle multiple constructor calls to different imported classes", () => {
      ...
      const logger_symbol = class_symbol(
        ...
        exports: [
          {
            ...
            exports: [
              { local_name: "Logger" as SymbolName, is_type_only: false },
            ],
            modifiers: [],
            language: "typescript",
            node_type: "export_statement",
        ...
        exports: [
          {
            ...
            exports: [
              { local_name: "Database" as SymbolName, is_type_only: false },
            ],
            modifiers: [],
            language: "typescript",
            node_type: "export_statement",
      ...
      expect(result.phases.methods.constructor_calls.get(logger_call_key)).toBe(
        logger_symbol
      );
      expect(result.phases.methods.constructor_calls.get(db_call_key)).toBe(
        db_symbol
      );

      // Verify both are in combined resolved references
      expect(result.resolved_references.get(logger_call_key)).toBe(
        logger_symbol
      );
  ...
  describe("Local constructor resolution", () => {
    it("should resolve constructor calls to classes in the same file", () => {
      ...
      const local_class_symbol = class_symbol(
    ...
    it("should resolve constructor calls with both local and imported classes (current behavior: imports take priority)", () => {
      ...
      const imported_utility_symbol = class_symbol(
        "Utility" as SymbolName,
        imported_class_location
      );
      const local_utility_symbol = class_symbol(
        "Utility" as SymbolName,
        ...
        exports: [
          {
            ...
            location: create_location(lib_path, 1, 0),
            exports: [
              { local_name: "Utility" as SymbolName, is_type_only: false },
            ],
            modifiers: [],
            language: "typescript",
            node_type: "export_statement",
        ...
        imports: [
          {
            kind: "named",
            imports: [
              { name: "MissingClass" as SymbolName, is_type_only: false },
            ],
        ...
        exports: [
          {
            ...
            location: create_location(lib_path, 1, 0),
            exports: [
              { local_name: "notAClass" as SymbolName, is_type_only: false },
            ],
            modifiers: [],
            language: "typescript",
            node_type: "export_statement",
  ...
  describe("Integration with other phases", () => {
    it("should work correctly when constructor resolution is part of full pipeline", () => {
      ...
      const constructor_call_location = create_location(app_path, 5, 20);
      const complex_class_symbol = class_symbol(
        ...
        exports: [
          {
            ...
            location: create_location(lib_path, 1, 0),
            exports: [
              { local_name: "ComplexClass" as SymbolName, is_type_only: false },
            ],
            modifiers: [],
            language: "typescript",
            node_type: "export_statement",
        ...
        imports: [
          {
            kind: "named",
            imports: [
              { name: "ComplexClass" as SymbolName, is_type_only: false },
            ],
            source: "./lib.ts" as FilePath,
            location: create_location(app_path, 1, 10),
            modifiers: [],
