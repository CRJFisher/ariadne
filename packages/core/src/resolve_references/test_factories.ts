...
import type { ProcessedReferences } from "../index_single_file/references";
import type { CallReference } from "../index_single_file/references/call_references";
import type { MemberAccessReference } from "../index_single_file/references/member_access_references";
import type { ReturnReference } from "../index_single_file/references/return_references";
import type { TypeAnnotationReference } from "../index_single_file/references/type_annotation_references/type_annotation_references";
import type { LocalTypeInfo } from "../index_single_file/definitions/type_members";
import type { LocalTypeAnnotation } from "../index_single_file/references/type_annotation_references";
