...
describe("AnalysisCache", () => {
  ...
  describe("Basic caching", () => {
    it("should cache and retrieve analysis", () => {
      ...
      // Cache the analysis
      cache.cache_analysis("/test/file.js", content, mockAnalysis);

      // Retrieve from cache
      const cached = cache.get_cached_analysis("/test/file.js", content);
    ...
    it("should invalidate cache on content change", () => {
      ...
      cache.cache_analysis("/test/file.js", content1, mockAnalysis);

      // Try to retrieve with different content
      const cached = cache.get_cached_analysis("/test/file.js", content2);
    ...
    it("should respect TTL", async () => {
      ...
      let cached = cache.get_cached_analysis("/test/file.js", content);
      expect(cached).toBeDefined();
      ...
      cached = cache.get_cached_analysis("/test/file.js", content);
    ...
    it("should evict oldest entries when full", () => {
      ...
      for (let i = 1; i <= 3; i++) {
        ...
        cache.cache_analysis(`/test/file${i}.js`, content, mockAnalysis);
      }

      // All should be cached
      expect(
        cache.get_cached_analysis("/test/file1.js", content)
      ).toBeDefined();
      expect(
        cache.get_cached_analysis("/test/file2.js", content)
      ).toBeDefined();
      expect(
        cache.get_cached_analysis("/test/file3.js", content)
      ).toBeDefined();
      ...
      cache.cache_analysis("/test/file4.js", content, mockAnalysis4);
      ...
      expect(
        cache.get_cached_analysis("/test/file4.js", content)
      ).toBeDefined();
    });
  });
  ...
  describe("Cache statistics", () => {
    it("should report cache stats", () => {
      ...
      cache.cache_analysis("/test/file.js", "const x = 1;", mockAnalysis);
  ...
  describe("Disabled cache", () => {
    it("should not cache when disabled", () => {
      ...
      // Try to cache
      disabledCache.cache_analysis("/test/file.js", content, mockAnalysis);

      // Should not be cached
      const cached = disabledCache.get_cached_analysis(
        "/test/file.js",
        content
      );
      expect(cached).toBeUndefined();
